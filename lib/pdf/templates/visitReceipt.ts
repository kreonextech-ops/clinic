...
<body>
  ...
  <div class="footer" style="display:flex;align-items:center;justify-between;padding-top:16px;">
    <div style="text-align:left;">
      <div style="font-weight:bold;color:#1e293b;">${clinicName} Verified Invoice</div>
      <div>Issued by ${doctorName} · Thank you for your visit!</div>
    </div>
    <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=${encodeURIComponent(`Verified Visit Receipt for ${patient.name} (${patient.patientId}) at ${clinicName}`)}" alt="QR Code Verification" style="width:65px;height:65px;border-radius:8px;border:1px solid #cbd5e1;padding:3px;" />
  </div>
</body>
</html>`;
}
